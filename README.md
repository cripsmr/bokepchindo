...
-   `SITENAME`: Name of the website (default: `bokep chindo`)
...
```bash
git clone <repo-url> bokepchindo
cd bokepchindo
```
...
1. Fork the [repository](https://github.com/cripsmr/bokepchindo/fork) on GitHub.
